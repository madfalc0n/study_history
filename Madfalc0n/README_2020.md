## 2020 Madfalcon's Study History
...
1. 데이콘 아리랑 위성영상 AI 객체 검출 경진대회 관련 레퍼런스 조사
...
1. 자소서 작성
2. 데이콘 아리랑 위성영상 AI 객체 검출 경진대회 데이터 검수3

## 2020-09-24

1. 자소서 작성
2. 데이콘 아리랑 위성영상 AI 객체 검출 경진대회 데이터 검수2
...
2. 코딩테스트 연습
   - 백준
     - [BFS,DFS](https://www.acmicpc.net/step/34)
3. 데이콘 아리랑 위성영상 AI 객체 검출 경진대회 데이터 검수
...
1. 코딩테스트 연습
   - 백준
     - [백트래킹 day](https://www.acmicpc.net/step/34)
       - [풀이리스트](https://github.com/madfalc0n/my_coding_labs/blob/master/algorithm/baekjun/back_tracking/)
2. 자소서 작성
